...
fn generate_demo_css() -> String {
    ...
    let demo_classes = vec![
        ...
        "min-h-screen", "bg-white", "dark:bg-zinc-900",
        "flex", "flex-col", "items-center", "justify-center",
        "p-8", "max-w-4xl", "mx-auto",
        
        // Typography
        "text-4xl", "font-bold", "text-zinc-900", "dark:text-zinc-100",
        "text-lg", "text-zinc-600", "dark:text-zinc-400", "mb-8",
        "text-2xl", "font-semibold", "text-blue-900", "dark:text-blue-100",
        "text-xl", "font-medium", "text-zinc-800", "dark:text-zinc-200",
        
        // Colors and backgrounds
        "bg-blue-50", "dark:bg-blue-900/20", "p-6", "rounded-lg",
        ...
        // Buttons and forms
        "px-6", "py-3", "rounded-md", "font-medium", "cursor-pointer",
        ...
        // Grid and flexbox
        "grid", "gap-4", "items-center", "justify-between",
        "flex-wrap", "gap-2", "mt-4",
        
        // Dark mode variants
        "dark:bg-zinc-900", "dark:text-zinc-100", "dark:text-zinc-400",
        "dark:border-zinc-700", "dark:ring-zinc-700",
        ...
        // Spacing
        "p-4", "m-4", "px-3", "py-2", "mt-2", "mb-3",
        "space-x-4", "space-y-2", "gap-4",
        
        // Borders and effects
        "border-2", "border-blue-500", "rounded-md", "rounded-lg",
...
"#, std::fs::read_to_string("web-demo.css").unwrap_or_default(), html);
