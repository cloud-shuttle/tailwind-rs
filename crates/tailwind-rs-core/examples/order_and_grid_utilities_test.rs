...
fn main() {
    ...
    let test_classes = vec![
        ...
        "order-[min(var(--total-items),10)]", "order-(--my-order)",
        
        // Grid template columns utilities
        "grid-cols-1", "grid-cols-2", "grid-cols-3", "grid-cols-4", "grid-cols-5", "grid-cols-6", "grid-cols-7", "grid-cols-8", "grid-cols-9", "grid-cols-10", "grid-cols-11", "grid-cols-12",
        "grid-cols-none", "grid-cols-subgrid",
        "grid-cols-[200px_minmax(900px,_1fr)_100px]", "grid-cols-(--my-grid-cols)",
        ...
        "col-[16_/_span_16]", "col-span-[3]", "col-start-[2]", "col-end-[4]",
        "col-(--my-columns)", "col-span-(--my-span)", "col-start-(--my-start)", "col-end-(--my-end)",
        ...
        "grid-rows-[200px_minmax(900px,1fr)_100px]", "grid-rows-(--my-grid-rows)",
        ...
        "row-[span_16_/_span_16]", "row-span-[3]", "row-start-[2]", "row-end-[4]",
        "row-(--my-rows)", "row-span-(--my-span)", "row-start-(--my-start)", "row-end-(--my-end)",
        ...
        "auto-cols-[minmax(0,2fr)]", "auto-cols-(--my-auto-cols)",
        
        // Grid auto rows utilities
        "auto-rows-auto", "auto-rows-min", "auto-rows-max", "auto-rows-fr",
        "auto-rows-[minmax(0,2fr)]", "auto-rows-(--my-auto-rows)",
    ];

    let mut working = 0;
    let mut broken = 0;

    println!("📋 Testing Order and Grid Utilities ({} classes):", test_classes.len());
