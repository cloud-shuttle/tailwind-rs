...
impl FlexboxParser {
    ...
    fn parse_align_self_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "self-auto" => Some(vec![CssProperty { name: "align-self".to_string(), value: "auto".to_string(), important: false }]),
            "self-start" => Some(vec![CssProperty { name: "align-self".to_string(), value: "flex-start".to_string(), important: false }]),
            "self-end" => Some(vec![CssProperty { name: "align-self".to_string(), value: "flex-end".to_string(), important: false }]),
            "self-center" => Some(vec![CssProperty { name: "align-self".to_string(), value: "center".to_string(), important: false }]),
            "self-stretch" => Some(vec![CssProperty { name: "align-self".to_string(), value: "stretch".to_string(), important: false }]),
            "self-baseline" => Some(vec![CssProperty { name: "align-self".to_string(), value: "baseline".to_string(), important: false }]),
            _ => None,
        }
    }
    ...
    fn parse_flex_grow_shrink_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "flex-1" => Some(vec![
                CssProperty { name: "flex".to_string(), value: "1 1 0%".to_string(), important: false }
            ]),
            "flex-auto" => Some(vec![
                CssProperty { name: "flex".to_string(), value: "1 1 auto".to_string(), important: false }
            ]),
            "flex-initial" => Some(vec![
                CssProperty { name: "flex".to_string(), value: "0 1 auto".to_string(), important: false }
            ]),
            "flex-none" => Some(vec![
                CssProperty { name: "flex".to_string(), value: "none".to_string(), important: false }
            ]),
            _ => None,
        }
    }
