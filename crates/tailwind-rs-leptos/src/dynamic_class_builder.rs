...
mod tests {
    ...
    fn test_dynamic_class_builder_base_classes() {
        let builder = DynamicClassBuilder::new().base("px-4 py-2");
    ...
    fn test_dynamic_class_builder_variant_classes() {
        let builder = DynamicClassBuilder::new().variant("bg-blue-600 text-white");
    ...
    fn test_dynamic_class_builder_responsive_classes() {
        let builder = DynamicClassBuilder::new().responsive("sm:text-sm md:text-base");
    ...
    fn test_dynamic_class_builder_state_classes() {
        let builder = DynamicClassBuilder::new().state("hover:bg-blue-700 focus:ring-2");
    ...
    fn test_dynamic_class_builder_custom_classes() {
        let builder = DynamicClassBuilder::new().custom("my-custom-class");
    ...
    fn test_dynamic_classes_utility() {
        let builder = dynamic_classes().base("px-4").variant("bg-blue-600");
