...
impl SelectorOptimizer {
    ...
    pub fn optimize_selectors(&self, css: &str) -> Result<SelectorOptimizationResult, OptimizationError> {
    ...
    fn find_redundant_selectors(&self, css: &str) -> Result<Vec<String>, OptimizationError> {
        ...
        for cap in rule_pattern.captures_iter(css) {
            ...
            selector_map.entry(properties).or_insert_with(Vec::new).push(selector);
        }
    ...
    fn remove_redundant_selector(&self, css: &str, selector: &str) -> Result<String, OptimizationError> {
    ...
    fn build_selector_rules() -> HashMap<String, SelectorRule> {
        ...
        rules.insert("universal".to_string(), SelectorRule {
