...
impl EffectsParser {
    ...
    fn parse_shadow_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            ...
            "shadow-inner" => Some(vec![CssProperty {
                name: "box-shadow".to_string(),
                value: "inset 0 2px 4px 0 rgb(0 0 0 / 0.05)".to_string(),
                important: false,
            }]),
    ...
    fn parse_backdrop_blur_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            ...
            "backdrop-blur-xs" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "blur(2px)".to_string(),
                important: false,
            }]),
            "backdrop-blur-sm" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "blur(4px)".to_string(),
                important: false,
            }]),
            "backdrop-blur" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
    ...
    fn parse_backdrop_opacity_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "backdrop-opacity-0" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-5" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.05)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-10" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.1)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-20" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.2)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-25" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.25)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-30" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.3)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-40" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.4)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-50" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.5)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-60" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.6)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-70" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.7)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-75" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.75)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-80" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.8)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-90" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.9)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-95" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(0.95)".to_string(),
                important: false,
            }]),
            "backdrop-opacity-100" => Some(vec![CssProperty {
                name: "backdrop-filter".to_string(),
                value: "opacity(1)".to_string(),
                important: false,
            }]),
            _ => None,
        }
