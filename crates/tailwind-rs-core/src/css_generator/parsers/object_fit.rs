...
impl ObjectFitParser {
    ...
    fn parse_object_fit_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "object-contain" => Some(vec![CssProperty {
                name: "object-fit".to_string(),
                value: "contain".to_string(),
                important: false,
            }]),
            "object-cover" => Some(vec![CssProperty {
                name: "object-fit".to_string(),
                value: "cover".to_string(),
                important: false,
            }]),
            "object-fill" => Some(vec![CssProperty {
                name: "object-fit".to_string(),
                value: "fill".to_string(),
                important: false,
            }]),
            "object-none" => Some(vec![CssProperty {
                name: "object-fit".to_string(),
                value: "none".to_string(),
                important: false,
            }]),
            "object-scale-down" => Some(vec![CssProperty {
                name: "object-fit".to_string(),
    ...
    fn parse_object_position_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            ...
            "object-left-bottom" => Some(vec![CssProperty {
                name: "object-position".to_string(),
                value: "left bottom".to_string(),
                important: false,
            }]),
            "object-left-top" => Some(vec![CssProperty {
                name: "object-position".to_string(),
                value: "left top".to_string(),
                important: false,
            }]),
            ...
            "object-right-bottom" => Some(vec![CssProperty {
                name: "object-position".to_string(),
                value: "right bottom".to_string(),
                important: false,
            }]),
            "object-right-top" => Some(vec![CssProperty {
                name: "object-position".to_string(),
                value: "right top".to_string(),
                important: false,
            }]),
