...
fn is_valid_property(property: &str) -> bool {
    ...
    let valid_properties = [
        ...
        // Typography
        "text", "font", "leading", "tracking", "indent", "text-indent",
        // Colors
        "bg", "text", "border", "ring", "accent", "caret", "fill", "stroke",
        // Borders
        "border", "border-t", "border-r", "border-b", "border-l", "border-x", "border-y",
        "rounded", "rounded-t", "rounded-r", "rounded-b", "rounded-l",
        "rounded-tl", "rounded-tr", "rounded-br", "rounded-bl",
        // Effects
        "shadow", "opacity", "backdrop-blur", "backdrop-brightness", "backdrop-contrast",
        "backdrop-grayscale", "backdrop-hue-rotate", "backdrop-invert", "backdrop-opacity",
        "backdrop-saturate", "backdrop-sepia", "blur", "brightness", "contrast", "drop-shadow",
        "grayscale", "hue-rotate", "invert", "saturate", "sepia",
        // Transforms
        "scale", "scale-x", "scale-y", "rotate", "translate-x", "translate-y", "skew-x", "skew-y",
        // Positioning
        "top", "right", "bottom", "left", "inset", "inset-x", "inset-y",
        // Z-index
        "z",
        // Grid
        "grid-cols", "grid-rows", "col-start", "col-end", "row-start", "row-end",
        "col-span", "row-span", "auto-cols", "auto-rows",
        // Flexbox
        "flex", "flex-grow", "flex-shrink", "flex-basis", "grow", "shrink", "basis",
        "order", "self", "place-self", "justify-self", "justify-items",
        // Animation
        "animate", "transition", "duration", "delay", "ease",
        // Interactivity
        "cursor", "select", "resize", "scroll", "touch", "will-change", "overscroll",
        // Accessibility
        "sr", "motion", "forced-color-adjust",
    ];
...
mod tests {
    ...
    fn test_arbitrary_value_validation() {
        ...
        assert!(ArbitraryValue::new("w", "invalid-value").validate().is_err());
    }
