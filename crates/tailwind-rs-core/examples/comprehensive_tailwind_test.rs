...
fn main() {
    ...
    let test_categories = vec![
        ("Layout & Display", vec![
            ...
            "inline-block", "inline-flex", "inline-grid", "table-cell", "table-row"
        ]),
        ("Positioning", vec![
        ...
        ("Spacing", vec![
            ...
            "m-0", "m-1", "m-2", "m-4", "m-8", "m-16", "m-32", "m-64",
            "px-0", "px-1", "px-2", "px-4", "px-8", "px-16", "px-32", "px-64",
            "py-0", "py-1", "py-2", "py-4", "py-8", "py-16", "py-32", "py-64",
            "pt-0", "pt-1", "pt-2", "pt-4", "pt-8", "pt-16", "pt-32", "pt-64",
            "pr-0", "pr-1", "pr-2", "pr-4", "pr-8", "pr-16", "pr-32", "pr-64",
            "pb-0", "pb-1", "pb-2", "pb-4", "pb-8", "pb-16", "pb-32", "pb-64",
            "pl-0", "pl-1", "pl-2", "pl-4", "pl-8", "pl-16", "pl-32", "pl-64",
            "mx-auto", "my-auto", "mt-auto", "mr-auto", "mb-auto", "ml-auto"
        ]),
        ("Sizing", vec![
            "w-0", "w-1", "w-2", "w-4", "w-8", "w-16", "w-32", "w-64", "w-full", "w-screen",
            "h-0", "h-1", "h-2", "h-4", "h-8", "h-16", "h-32", "h-64", "h-full", "h-screen",
            "min-w-0", "min-w-full", "min-w-min", "min-w-max", "min-w-fit",
            "max-w-0", "max-w-none", "max-w-xs", "max-w-sm", "max-w-md", "max-w-lg", "max-w-xl", "max-w-2xl", "max-w-4xl", "max-w-6xl", "max-w-7xl", "max-w-full", "max-w-screen-sm", "max-w-screen-md", "max-w-screen-lg", "max-w-screen-xl", "max-w-screen-2xl",
            "min-h-0", "min-h-full", "min-h-screen",
            "max-h-0", "max-h-1", "max-h-2", "max-h-4", "max-h-8", "max-h-16", "max-h-32", "max-h-64", "max-h-full", "max-h-screen"
        ]),
        ("Typography", vec![
        ...
        ("Grid", vec![
            ...
            "gap-0", "gap-1", "gap-2", "gap-4", "gap-8", "gap-16", "gap-32", "gap-64",
            "gap-x-0", "gap-x-1", "gap-x-2", "gap-x-4", "gap-x-8", "gap-x-16", "gap-x-32", "gap-x-64",
            "gap-y-0", "gap-y-1", "gap-y-2", "gap-y-4", "gap-y-8", "gap-y-16", "gap-y-32", "gap-y-64"
        ]),
        ("Effects", vec![
        ...
        ("Transforms", vec![
            ...
            "translate-x-0", "translate-x-1", "translate-x-2", "translate-x-4", "translate-x-8", "translate-x-16", "translate-x-32", "translate-x-64",
            "translate-y-0", "translate-y-1", "translate-y-2", "translate-y-4", "translate-y-8", "translate-y-16", "translate-y-32", "translate-y-64",
        ...
        ("Responsive", vec![
            "sm:block", "sm:inline", "sm:flex", "sm:grid", "sm:hidden",
            "md:block", "md:inline", "md:flex", "md:grid", "md:hidden",
            "lg:block", "lg:inline", "lg:flex", "lg:grid", "lg:hidden",
            "xl:block", "xl:inline", "xl:flex", "xl:grid", "xl:hidden",
            "2xl:block", "2xl:inline", "2xl:flex", "2xl:grid", "2xl:hidden"
        ]),
        ("States", vec![
            "hover:bg-blue-500", "hover:text-white", "hover:border-gray-300",
            "focus:bg-blue-500", "focus:text-white", "focus:border-gray-300", "focus:ring-2", "focus:ring-blue-500",
            "active:bg-blue-600", "active:text-white", "active:border-gray-400",
            "disabled:bg-gray-300", "disabled:text-gray-500", "disabled:cursor-not-allowed"
        ]),
        ("Dark Mode", vec![
            "dark:bg-gray-800", "dark:text-white", "dark:border-gray-700",
            "dark:hover:bg-gray-700", "dark:hover:text-gray-200", "dark:hover:border-gray-600",
            "dark:focus:bg-gray-700", "dark:focus:text-gray-200", "dark:focus:border-gray-600"
        ]),
        ("Arbitrary Values", vec![
            "w-[100px]", "h-[50px]", "bg-[#ff0000]", "text-[#00ff00]",
            "top-[4px]", "left-[7px]", "right-[10px]", "bottom-[15px]",
            "p-[20px]", "m-[30px]", "gap-[40px]"
        ]),
        ("Aspect Ratio", vec![
            "aspect-auto", "aspect-square", "aspect-video",
            "aspect-3/2", "aspect-4/3", "aspect-16/9",
            "aspect-[2/1]", "aspect-[calc(4*3+1)/3]", "aspect-(--my-aspect-ratio)"
        ]),
        ("Columns", vec![
            "columns-1", "columns-2", "columns-3", "columns-4", "columns-5", "columns-6",
            "columns-3xs", "columns-2xs", "columns-xs", "columns-sm", "columns-md",
            "columns-lg", "columns-xl", "columns-2xl", "columns-3xl", "columns-4xl",
            "columns-5xl", "columns-6xl", "columns-7xl",
            "columns-[30vw]", "columns-(--my-columns)"
        ]),
        ("Break Control", vec![
        ...
        ("Layout Utilities", vec![
            "float-right", "float-left", "float-start", "float-end", "float-none",
            ...
            "object-[25%_75%]", "object-(--my-object)"
        ])
    ];
    ...
    for (category_name, classes) in &test_categories {
        ...
        println!("  📊 {}: {}/{} ({:.1}%)", category_name, working, classes.len(), coverage);
    }
    ...
    for (category, working, broken, coverage) in &category_results {
        println!("  {}: {}/{} ({:.1}%)", category, working, working + broken, coverage);
    }
