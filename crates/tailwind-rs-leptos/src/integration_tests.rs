//! Integration tests for tailwind-rs-leptos with new parser functionality
...
mod tests {
    ...
    #[test]
    fn test_leptos_integration_with_new_parsers() {
        // Test that Leptos integration works with the new BasicTransformsParser and ScaleParser
        ...
        println!("✅ Leptos integration successfully generates CSS for new parser classes");
