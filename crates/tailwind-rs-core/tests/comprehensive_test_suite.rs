...
mod performance_tests {
    ...
    fn test_large_class_sets() {
        ...
        let valid_text = ["text-xs", "text-sm", "text-base", "text-lg", "text-xl", "text-2xl", "text-3xl", "text-4xl", "text-5xl", "text-6xl"];
        let valid_bg = ["bg-blue-50", "bg-blue-100", "bg-blue-200", "bg-blue-300", "bg-blue-400", "bg-blue-500", "bg-blue-600", "bg-blue-700", "bg-blue-800", "bg-blue-900"];
    ...
    fn test_memory_usage() {
        ...
        let valid_classes = ["p-1", "p-2", "p-3", "p-4", "p-5", "m-1", "m-2", "m-3", "m-4", "m-5", "text-sm", "text-base", "text-lg", "bg-blue-500", "bg-red-500", "bg-green-500"];
        for i in 0..1000 {
            generator.add_class(valid_classes[i % valid_classes.len()]).unwrap();
        }
