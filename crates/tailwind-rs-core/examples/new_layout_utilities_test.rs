...
fn main() {
    ...
    let test_classes = vec![
        ...
        // Inset utilities
        "inset-0", "inset-4", "inset-auto", "inset-full",
        "inset-x-0", "inset-x-4", "inset-y-0", "inset-y-4",
        "top-0", "top-4", "top-auto", "right-0", "right-4", "right-auto",
        "bottom-0", "bottom-4", "bottom-auto", "left-0", "left-4", "left-auto",
        "start-0", "start-4", "start-auto", "end-0", "end-4", "end-auto",
        "inset-[10px]", "top-[5px]", "right-[15px]", "bottom-[20px]", "left-[25px]",
        "inset-(--my-inset)", "top-(--my-top)",
    ...
    println!("📋 Testing New Layout Utilities ({} classes):", test_classes.len());
