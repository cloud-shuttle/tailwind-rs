...
impl LayoutUtilitiesParser {
    ...
    fn parse_float_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "float-right" => Some(vec![CssProperty { name: "float".to_string(), value: "right".to_string(), important: false }]),
            "float-left" => Some(vec![CssProperty { name: "float".to_string(), value: "left".to_string(), important: false }]),
            "float-start" => Some(vec![CssProperty { name: "float".to_string(), value: "inline-start".to_string(), important: false }]),
            "float-end" => Some(vec![CssProperty { name: "float".to_string(), value: "inline-end".to_string(), important: false }]),
            "float-none" => Some(vec![CssProperty { name: "float".to_string(), value: "none".to_string(), important: false }]),
            _ => None,
        }
    }
    ...
    fn parse_clear_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "clear-left" => Some(vec![CssProperty { name: "clear".to_string(), value: "left".to_string(), important: false }]),
            "clear-right" => Some(vec![CssProperty { name: "clear".to_string(), value: "right".to_string(), important: false }]),
            "clear-both" => Some(vec![CssProperty { name: "clear".to_string(), value: "both".to_string(), important: false }]),
            "clear-start" => Some(vec![CssProperty { name: "clear".to_string(), value: "inline-start".to_string(), important: false }]),
            "clear-end" => Some(vec![CssProperty { name: "clear".to_string(), value: "inline-end".to_string(), important: false }]),
            "clear-none" => Some(vec![CssProperty { name: "clear".to_string(), value: "none".to_string(), important: false }]),
            _ => None,
        }
    }
    ...
    fn parse_isolation_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "isolate" => Some(vec![CssProperty { name: "isolation".to_string(), value: "isolate".to_string(), important: false }]),
            "isolation-auto" => Some(vec![CssProperty { name: "isolation".to_string(), value: "auto".to_string(), important: false }]),
            _ => None,
        }
    }
    ...
    fn parse_object_position_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "object-top-left" => Some(vec![CssProperty { name: "object-position".to_string(), value: "top left".to_string(), important: false }]),
            "object-top" => Some(vec![CssProperty { name: "object-position".to_string(), value: "top".to_string(), important: false }]),
            "object-top-right" => Some(vec![CssProperty { name: "object-position".to_string(), value: "top right".to_string(), important: false }]),
            ...
            "object-bottom-left" => Some(vec![CssProperty { name: "object-position".to_string(), value: "bottom left".to_string(), important: false }]),
            "object-bottom" => Some(vec![CssProperty { name: "object-position".to_string(), value: "bottom".to_string(), important: false }]),
            "object-bottom-right" => Some(vec![CssProperty { name: "object-position".to_string(), value: "bottom right".to_string(), important: false }]),
            _ => None,
        }
    }
    ...
    fn parse_arbitrary_object_position_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        if let Some(value) = class.strip_prefix("object-[") {
            if let Some(value) = value.strip_suffix("]") {
                return Some(vec![CssProperty { name: "object-position".to_string(), value: value.to_string(), important: false }]);
            }
        }
        None
    }
    ...
    fn parse_custom_property_object_position_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        if let Some(prop) = class.strip_prefix("object-(") {
            if let Some(prop) = prop.strip_suffix(")") {
                return Some(vec![CssProperty { name: "object-position".to_string(), value: format!("var({})", prop), important: false }]);
            }
        }
        None
    }
