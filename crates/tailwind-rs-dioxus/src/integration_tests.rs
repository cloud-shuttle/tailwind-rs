//! Integration tests for tailwind-rs-dioxus with new parser functionality
...
mod tests {
    ...
    #[test]
    fn test_dioxus_integration_with_new_parsers() {
        // Test that Dioxus integration works with the new BasicTransformsParser and ScaleParser
        ...
        println!("✅ Dioxus integration successfully generates CSS for new parser classes");
