...
impl BoxUtilitiesParser {
    ...
    fn parse_box_decoration_break_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "box-decoration-clone" => Some(vec![CssProperty {
                name: "box-decoration-break".to_string(),
                value: "clone".to_string(),
                important: false,
            }]),
            "box-decoration-slice" => Some(vec![CssProperty {
                name: "box-decoration-break".to_string(),
    ...
    fn parse_box_sizing_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "box-border" => Some(vec![CssProperty {
                name: "box-sizing".to_string(),
                value: "border-box".to_string(),
                important: false,
            }]),
            "box-content" => Some(vec![CssProperty {
                name: "box-sizing".to_string(),
    ...
    fn parse_display_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "flow-root" => Some(vec![CssProperty {
                name: "display".to_string(),
                value: "flow-root".to_string(),
                important: false,
            }]),
            "table-caption" => Some(vec![CssProperty {
                name: "display".to_string(),
                value: "table-caption".to_string(),
                important: false,
            }]),
            "table-column" => Some(vec![CssProperty {
                name: "display".to_string(),
                value: "table-column".to_string(),
                important: false,
            }]),
            "table-column-group" => Some(vec![CssProperty {
                name: "display".to_string(),
                value: "table-column-group".to_string(),
                important: false,
            }]),
            "table-header-group" => Some(vec![CssProperty {
                name: "display".to_string(),
                value: "table-header-group".to_string(),
                important: false,
            }]),
            "table-row-group" => Some(vec![CssProperty {
                name: "display".to_string(),
                value: "table-row-group".to_string(),
                important: false,
            }]),
            "table-footer-group" => Some(vec![CssProperty {
                name: "display".to_string(),
                value: "table-footer-group".to_string(),
                important: false,
            }]),
            "sr-only" => Some(vec![
                CssProperty {
