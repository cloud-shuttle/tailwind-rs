...
impl LayoutParser {
    ...
    fn parse_visibility_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "visible" => Some(vec![CssProperty { name: "visibility".to_string(), value: "visible".to_string(), important: false }]),
            "invisible" => Some(vec![CssProperty { name: "visibility".to_string(), value: "hidden".to_string(), important: false }]),
            _ => None,
        }
    }
    ...
    fn parse_overflow_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "overflow-auto" => Some(vec![CssProperty { name: "overflow".to_string(), value: "auto".to_string(), important: false }]),
            "overflow-hidden" => Some(vec![CssProperty { name: "overflow".to_string(), value: "hidden".to_string(), important: false }]),
            "overflow-clip" => Some(vec![CssProperty { name: "overflow".to_string(), value: "clip".to_string(), important: false }]),
            "overflow-visible" => Some(vec![CssProperty { name: "overflow".to_string(), value: "visible".to_string(), important: false }]),
            "overflow-scroll" => Some(vec![CssProperty { name: "overflow".to_string(), value: "scroll".to_string(), important: false }]),
            "overflow-x-auto" => Some(vec![CssProperty { name: "overflow-x".to_string(), value: "auto".to_string(), important: false }]),
            "overflow-x-hidden" => Some(vec![CssProperty { name: "overflow-x".to_string(), value: "hidden".to_string(), important: false }]),
            "overflow-x-clip" => Some(vec![CssProperty { name: "overflow-x".to_string(), value: "clip".to_string(), important: false }]),
            "overflow-x-visible" => Some(vec![CssProperty { name: "overflow-x".to_string(), value: "visible".to_string(), important: false }]),
            "overflow-x-scroll" => Some(vec![CssProperty { name: "overflow-x".to_string(), value: "scroll".to_string(), important: false }]),
            "overflow-y-auto" => Some(vec![CssProperty { name: "overflow-y".to_string(), value: "auto".to_string(), important: false }]),
            "overflow-y-hidden" => Some(vec![CssProperty { name: "overflow-y".to_string(), value: "hidden".to_string(), important: false }]),
            "overflow-y-clip" => Some(vec![CssProperty { name: "overflow-y".to_string(), value: "clip".to_string(), important: false }]),
            "overflow-y-visible" => Some(vec![CssProperty { name: "overflow-y".to_string(), value: "visible".to_string(), important: false }]),
            "overflow-y-scroll" => Some(vec![CssProperty { name: "overflow-y".to_string(), value: "scroll".to_string(), important: false }]),
            _ => None,
        }
    }
}
