...
fn main() {
    ...
    let test_classes = vec![
        ...
        "bg-red-500", "bg-blue-600", "bg-green-700",
        "bg-blue-600/50", "bg-red-500/75",
        "bg-(--my-color)", "bg-[#50d71e]",
        
        // Background Image
        "bg-none", "bg-[url(/img/mountains.jpg)]",
        ...
        "bg-linear-45deg", "bg-linear-90deg", "bg-linear-180deg",
        "bg-radial", "bg-radial-[at_50%_50%]", "bg-radial-[at_25%_25%]",
        "bg-conic", "bg-conic-45deg", "bg-conic-180deg",
        
        // Background Origin
        "bg-origin-border", "bg-origin-padding", "bg-origin-content",
        
        // Background Position
        "bg-top-left", "bg-top", "bg-top-right", "bg-left", "bg-center", "bg-right",
        "bg-bottom-left", "bg-bottom", "bg-bottom-right",
        "bg-position-(--my-position)", "bg-position-[center_top_1rem]",
        
        // Background Repeat
        "bg-repeat", "bg-repeat-x", "bg-repeat-y", "bg-repeat-space", "bg-repeat-round", "bg-no-repeat",
        
        // Background Size
        "bg-auto", "bg-cover", "bg-contain",
        "bg-size-(--my-size)", "bg-size-[auto_100px]",
    ];
