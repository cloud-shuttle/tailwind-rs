...
fn main() {
    ...
    // Conditional classes
    let is_active = true;
    let conditional_classes = format!("px-4 py-2 rounded-md font-medium {} transition-colors", 
    ...
    println!("Generated CSS (first 100 chars): {}...", &css[..100.min(css.len())]);
    ...
    let variants = [ButtonVariant::Primary, ButtonVariant::Secondary, ButtonVariant::Danger];
    ...
    println!("String is {:.1}x faster", rust_duration.as_nanos() as f64 / string_duration.as_nanos() as f64);
