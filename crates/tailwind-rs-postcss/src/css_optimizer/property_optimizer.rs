...
impl PropertyOptimizer {
    ...
    pub fn optimize_properties(&self, css: &str) -> Result<PropertyOptimizationResult, OptimizationError> {
    ...
    fn optimize_rule_properties(&self, properties_str: &str) -> Result<Vec<CSSProperty>, OptimizationError> {
    ...
    fn build_property_rules() -> HashMap<String, PropertyRule> {
        ...
        rules.insert("margin".to_string(), PropertyRule {
            name: "margin".to_string(),
            shorthand: true,
            longhand: vec!["margin-top".to_string(), "margin-right".to_string(), 
                          "margin-bottom".to_string(), "margin-left".to_string()],
        });
        
        rules.insert("padding".to_string(), PropertyRule {
            name: "padding".to_string(),
            shorthand: true,
            longhand: vec!["padding-top".to_string(), "padding-right".to_string(), 
                          "padding-bottom".to_string(), "padding-left".to_string()],
        });
