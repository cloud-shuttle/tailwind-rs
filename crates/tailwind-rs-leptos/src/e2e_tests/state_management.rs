...
fn test_complex_state_component_logic() -> bool {
    ...
    initial_count && initial_loading && initial_error && initial_items &&
    updated_count && updated_loading && updated_error && updated_items
}
...
fn test_state_interactions() -> bool {
    ...
    initial_can_increment && loading_cannot_increment && error_cannot_increment && normal_can_increment
}
...
fn test_complex_class_logic() -> bool {
    ...
    let normal_passed = normal_classes.contains("border-gray-300") && normal_classes.contains("bg-white");
    
    // Test loading state
    set_loading.set(true);
    let loading_classes = container_classes();
    let loading_passed = loading_classes.contains("border-yellow-500") && loading_classes.contains("bg-yellow-50");
    
    // Test error state
    set_loading.set(false);
    set_error.set(Some("error".to_string()));
    let error_classes = container_classes();
    let error_passed = error_classes.contains("border-red-500") && error_classes.contains("bg-red-50");
