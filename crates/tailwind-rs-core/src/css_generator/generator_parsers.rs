...
use super::parsers::{
    AccessibilityParser, AlignContentParser, AlignItemsParser, AlignSelfParser,
    BackdropFilterUtilitiesParser, BackgroundParser, BorderParser, BorderUtilitiesParser,
    ColorParser, EffectsParser, EffectsUtilitiesParser, FilterUtilitiesParser, FlexBasisParser,
    FlexDirectionParser, FlexGrowParser, FlexParser, FlexShrinkParser, FlexWrapParser,
    FlexboxParser, GapParser, GridAutoColumnsParser, GridAutoFlowParser, GridAutoRowsParser,
    GridColumnParser, GridParser, GridRowParser, GridTemplateColumnsParser, GridTemplateRowsParser,
    InsetParser, JustifyContentParser, JustifyItemsParser, JustifySelfParser, LayoutParser,
    MaskUtilitiesParser, OrderParser, OverflowParser, OverscrollParser, PlaceContentParser,
    PlaceItemsParser, PlaceSelfParser, PositionParser, TableParser, TransformParser,
    TypographyParser, UtilityParser, VisibilityParser, ZIndexParser,
};
...
impl super::CssGenerator {
    ...
    fn parse_transition_class(&self, _class: &str) -> Option<Vec<CssProperty>> {
        None
    }
