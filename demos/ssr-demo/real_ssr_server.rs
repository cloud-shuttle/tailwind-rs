...
fn generate_html() -> String {
    ...
    let server_info = format!("Rust SSR Server - {}", timestamp);
...
<head>
    ...
    <meta name="description" content="Real Server-Side Rendering demo for Tailwind-RS with Rust">
                ...
                <div class="bg-green-100 dark:bg-green-900 border border-green-400 dark:border-green-600 rounded-lg p-6">
                    ...
                    <div class="bg-green-200 dark:bg-green-800 rounded p-3">
                        <p class="text-sm text-green-800 dark:text-green-200">
                            Server: {} | Timestamp: {} | Framework: Rust + Tailwind-RS
                        </p>
                    </div>
                </div>
...
"#, server_info, timestamp, server_info, timestamp)
}
