...
fn main() {
    ...
    let test_classes = vec![
        ...
        "text-red-500", "text-blue-600", "text-green-700", "text-blue-600/50", "text-red-500/75",
        "text-(--my-color)", "text-[#50d71e]",
        ...
        "decoration-red-500", "decoration-blue-600", "decoration-green-700", "decoration-blue-600/50", "decoration-red-500/75",
        "decoration-(--my-color)", "decoration-[#50d71e]",
        
        // Text Decoration Style
        "decoration-solid", "decoration-double", "decoration-dotted", "decoration-dashed", "decoration-wavy",
        
        // Text Decoration Thickness
        "decoration-from-font", "decoration-auto", "decoration-1", "decoration-2", "decoration-4", "decoration-8",
        "decoration-(--my-thickness)", "decoration-[0.25rem]",
        
        // Text Underline Offset
        "underline-offset-auto", "underline-offset-1", "underline-offset-2", "underline-offset-4", "underline-offset-8",
        "-underline-offset-1", "-underline-offset-2", "underline-offset-(--my-offset)", "underline-offset-[3px]",
        ...
        // Text Indent
        "indent-px", "-indent-px", "indent-2", "indent-4", "indent-8", "-indent-2", "-indent-4",
        "indent-(--my-indent)", "indent-[50%]",
    ];
