...
fn main() {
    ...
    let fractional_classes = ClassBuilder::new()
        ...
        .build();
    println!("  Fractional padding: {}", fractional_classes.to_css_classes());
    ...
    println!("  px-0.5 CSS value: {}", SpacingValue::Fractional(0.5).to_css_value());
    println!("  m-auto CSS value: {}", SpacingValue::Auto.to_css_value());
    println!("  gap-full CSS value: {}", SpacingValue::Full.to_css_value());
    ...
    println!("   - {} spacing values supported", SpacingValue::all_values().len());
