...
impl AdvancedSourceMapGenerator {
    ...
    fn generate_transformation_mappings(&mut self, transformation: Transformation) -> Result<(), AdvancedFeatureError> {
        // Find source file index
        let source_index = self.sources.iter()
    ...
    fn encode_mappings(&self, mappings: &[SourceMapping]) -> Result<String, AdvancedFeatureError> {
        ...
        for mapping in mappings {
            ...
            let generated_column_delta = (mapping.generated_column - previous_generated_column) as isize;
            ...
            let source_file_delta = (mapping.source_file.unwrap_or(0) - previous_source_file) as isize;
    ...
    fn get_source_content(&self, source_file: &SourceFile, line: usize) -> Result<String, AdvancedFeatureError> {
...
impl SourceMap {
    ...
    pub fn to_json(&self) -> Result<String, AdvancedFeatureError> {
        serde_json::to_string_pretty(self)
            .map_err(|e| AdvancedFeatureError::SourceMapFailed {
