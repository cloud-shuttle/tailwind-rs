//! Ring Offset Width Parser
//!
//! This module provides parsing logic for ring-offset-width related Tailwind CSS utilities.

use crate::css_generator::types::CssProperty;

/// Parse ring-offset-width classes
pub fn parse_ring_offset_width_class(class: &str) -> Option<Vec<CssProperty>> {
    match class {
...
/// Ring offset width parser
pub struct RingOffsetWidthParser;

impl RingOffsetWidthParser {
    pub fn new() -> Self {
        Self
    }

    pub fn parse(&self, class: &str) -> Option<Vec<CssProperty>> {
        parse_ring_offset_width_class(class)
    }
}
