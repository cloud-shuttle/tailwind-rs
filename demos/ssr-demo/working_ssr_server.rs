...
/// Generate CSS for the SSR demo using Tailwind-RS
fn generate_demo_css() -> String {
    ...
    let classes = vec![
        ...
        "bg-green-200", "dark:bg-green-800", "rounded", "p-3",
        "text-sm", "text-green-800", "dark:text-green-200",
        "text-lg", "text-gray-600", "dark:text-gray-300",
        "space-x-4", "bg-red-500", "hover:bg-red-600",
        "bg-gray-500", "hover:bg-gray-600",
        "p-4", "bg-gradient-to-r", "from-purple-400", "to-pink-400",
...
<head>
    ...
    <title>Tailwind-RS Real Rust SSR Demo</title>
    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        <div class="container mx-auto px-4 py-8">
            <h1 class="text-4xl font-bold text-center mb-8 text-gray-800 dark:text-white">
                🚀 Real Rust Server-Side Rendering
            </h1>
            ...
            <div class="max-w-4xl mx-auto space-y-6">
                ...
                <div class="bg-green-100 dark:bg-green-900 border border-green-400 dark:border-green-600 rounded-lg p-6">
                    ...
                    <div class="bg-green-200 dark:bg-green-800 rounded p-3">
                        <p class="text-sm text-green-800 dark:text-green-200">
                            <strong>Server:</strong> Rust HTTP Server | 
                            <strong>Timestamp:</strong> {} | 
                            <strong>Process ID:</strong> {} | 
                            <strong>Framework:</strong> Rust + Tailwind-RS
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-blue-100 dark:bg-blue-900 border border-blue-400 dark:border-blue-600 rounded-lg p-6">
                    ...
                    <ul class="text-blue-700 dark:text-blue-300 space-y-1">
                        <li>• <strong>Server-side rendering with Rust</strong></li>
                        <li>• <strong>Tailwind-RS class generation</strong></li>
                        <li>• <strong>Dynamic server data injection</strong></li>
                        <li>• <strong>SEO-friendly HTML output</strong></li>
                        <li>• <strong>Fast initial page load</strong></li>
                        <li>• <strong>Real-time server data</strong></li>
                        <li>• <strong>Process ID: {}</strong></li>
                    </ul>
                </div>

                <div class="text-center text-gray-600 dark:text-gray-400">
                    <p>Built with <strong>Real Rust SSR</strong> and Tailwind-RS</p>
...
"#, timestamp, process_id, process_id, timestamp, format!("{}", timestamp), process_id, timestamp)
}
...
fn main() -> std::io::Result<()> {
    println!("🚀 Starting Tailwind-RS Real Rust SSR Demo server...");
