...
fn main() {
    ...
    let core_features = vec![
        ...
        // Spacing
        "p-4", "m-2", "px-6", "py-3", "pt-8", "pb-4", "pl-2", "pr-6",
        "mx-auto", "my-4", "mt-6", "mb-8", "ml-2", "mr-4",
        
        // Sizing
        "w-full", "h-screen", "max-w-4xl", "min-h-screen", "size-12", "size-6",
        
        // Typography
        "text-lg", "text-sm", "font-bold", "font-medium", "tracking-tight",
        "text-center", "text-left", "text-right", "leading-relaxed",
        
        // Colors
        "bg-blue-500", "text-white", "border-gray-200", "ring-blue-500",
        "bg-white/90", "text-black/50", "border-black/5",
        
        // States
        "hover:bg-blue-600", "focus:ring-2", "active:scale-95",
        "group-hover:opacity-100", "dark:bg-zinc-800", "dark:text-white",
        
        // Responsive
        "sm:text-lg", "md:flex-row", "lg:grid-cols-3", "xl:relative",
        
        // Advanced
        "backdrop-blur-sm", "drop-shadow-lg", "transform", "transition-all",
        "data-hover:bg-black/5", "data-closed:opacity-0",
        
        // Arbitrary values
        "w-[100px]", "h-[50px]", "bg-[url(/image.png)]", "top-[4px]",
        
        // Complex features
        "bg-gradient-to-r", "from-blue-500", "to-purple-600",
        "divide-y", "divide-gray-200", "object-cover", "origin-top",
    ];
