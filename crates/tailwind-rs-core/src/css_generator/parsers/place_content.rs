...
impl PlaceContentParser {
    pub fn new() -> Self {
        ...
        place_content_map.insert("place-content-center-safe".to_string(), "safe center".to_string());
        ...
        place_content_map.insert("place-content-between".to_string(), "space-between".to_string());
        place_content_map.insert("place-content-around".to_string(), "space-around".to_string());
        place_content_map.insert("place-content-evenly".to_string(), "space-evenly".to_string());
    ...
    fn parse_place_content_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        if let Some(place_content_value) = self.place_content_map.get(class) {
            return Some(vec![CssProperty { name: "place-content".to_string(), value: place_content_value.clone(), important: false }]);
        }
        None
    }
}
...
impl UtilityParser for PlaceContentParser {
    ...
    fn get_supported_patterns(&self) -> Vec<&'static str> {
        vec![
            "place-content-center", "place-content-center-safe", "place-content-start", "place-content-end", "place-content-end-safe",
