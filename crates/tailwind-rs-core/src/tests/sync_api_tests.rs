...
mod sync_performance_optimizer_tests {
    ...
    fn test_optimize_class_generation_sync() {
        ...
        let classes = vec!["px-4".to_string(), "py-2".to_string(), "bg-blue-500".to_string()];
    ...
    fn test_optimization_levels() {
        ...
        let mut optimizer_none = PerformanceOptimizer::with_optimization_level(OptimizationLevel::None);
        let mut optimizer_low = PerformanceOptimizer::with_optimization_level(OptimizationLevel::Low);
        let mut optimizer_high = PerformanceOptimizer::with_optimization_level(OptimizationLevel::High);
    ...
    fn test_performance_metrics_sync() {
        ...
        // Record some metrics
        optimizer.record_performance("test_operation", std::time::Duration::from_millis(100), true);
        optimizer.record_error("test_error", &std::io::Error::new(std::io::ErrorKind::Other, "test"));
...
mod integration_tests {
    ...
    fn test_performance_under_load() {
        ...
        let mut optimizer = PerformanceOptimizer::with_optimization_level(OptimizationLevel::Maximum);
