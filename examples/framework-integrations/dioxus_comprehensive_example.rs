//! Comprehensive Dioxus Integration Example
//! 
//! This example demonstrates the full capabilities of Tailwind-RS with Dioxus,
//! including cross-platform UI, state management, and advanced styling.
                    ...
                    div { class: card_classes.to_string(),
                        div { class: "text-center space-y-6",
                            ...
                            p { class: "text-lg text-gray-600 dark:text-gray-300",
                                "A comprehensive example showcasing cross-platform styling"
                            }
                            ...
                            div { class: "mt-8 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg",
                                ...
                                ul { class: "text-sm text-green-700 dark:text-green-300 space-y-1",
                                    li { "• Cross-platform UI development" }
                                    li { "• Reactive state management" }
                                    li { "• Dark mode support" }
                                    li { "• Hover and active states" }
                                    li { "• Transform animations" }
                                    li { "• Backdrop blur effects" }
                                    li { "• Gradient backgrounds" }
...
#[component]
fn InteractiveButton(props: ButtonProps) -> Element {
...
#[component]
fn StyledCard(props: CardProps) -> Element {
    let card_classes = ClassBuilder::new()
        .class("bg-white")
        .class("dark:bg-gray-800")
        .class("rounded-xl")
    ...
    rsx! {
        div { class: card_classes.to_string(),
            h3 { class: title_classes.to_string(), "{props.title}" }
            p { class: description_classes.to_string(), "{props.description}" }
            div { class: "space-y-2",
                {props.children}
            }
        }
...
/// Main function to run the Dioxus app
fn main() {
    dioxus::launch(App);
}
