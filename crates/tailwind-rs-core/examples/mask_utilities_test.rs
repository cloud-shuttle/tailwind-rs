...
fn main() {
    ...
    let test_classes = vec![
        // Mask Image
        "mask-none", "mask-[url(/img/scribble.png)]", "mask-(--my-mask)",
        "mask-linear-45", "mask-linear-90", "mask-linear-180", "-mask-linear-45",
        "mask-linear-from-20", "mask-linear-from-50%", "mask-linear-from-[10px]",
        "mask-t-from-50%", "mask-r-from-30%", "mask-b-from-20%", "mask-l-from-50%",
        "mask-x-from-70%", "mask-y-from-70%", "mask-x-to-90%", "mask-y-to-90%",
        "mask-radial-from-75%", "mask-radial-from-100%", "mask-radial-to-85%",
        "mask-conic-from-75%", "mask-conic-to-75%", "mask-conic-45",
        ...
        // Mask Position
        "mask-top-left", "mask-top", "mask-top-right", "mask-left", "mask-center",
        "mask-right", "mask-bottom-left", "mask-bottom", "mask-bottom-right",
        "mask-position-(--my-position)", "mask-position-[center_top_1rem]",
        
        // Mask Repeat
        "mask-repeat", "mask-no-repeat", "mask-repeat-x", "mask-repeat-y",
        "mask-repeat-space", "mask-repeat-round",
        
        // Mask Size
        "mask-auto", "mask-cover", "mask-contain",
        "mask-size-(--my-size)", "mask-size-[auto_100px]",
