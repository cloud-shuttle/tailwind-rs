...
fn main() {
    ...
    let test_classes = vec![
        // Border Radius
        "rounded-xs", "rounded-sm", "rounded", "rounded-md", "rounded-lg", "rounded-xl", 
        "rounded-2xl", "rounded-3xl", "rounded-4xl", "rounded-none", "rounded-full",
        "rounded-t-lg", "rounded-r-lg", "rounded-b-lg", "rounded-l-lg",
        "rounded-tl-lg", "rounded-tr-lg", "rounded-br-lg", "rounded-bl-lg",
        "rounded-(--my-radius)", "rounded-[2vw]",
        
        // Border Width
        "border", "border-0", "border-2", "border-4", "border-8",
        "border-t-4", "border-r-4", "border-b-4", "border-l-4",
        "border-x-4", "border-y-4",
        "border-(length:--my-width)", "border-[2vw]",
        
        // Border Color
        "border-inherit", "border-current", "border-transparent", "border-black", "border-white",
        "border-red-500", "border-blue-600", "border-green-700",
        "border-blue-600/50", "border-red-500/75",
        "border-t-indigo-500", "border-r-indigo-500", "border-b-indigo-500", "border-l-indigo-500",
        "border-x-indigo-500", "border-y-indigo-500",
        "border-(--my-color)", "border-[#243c5a]",
        
        // Border Style
        "border-solid", "border-dashed", "border-dotted", "border-double", "border-hidden", "border-none",
        
        // Outline Width
        "outline", "outline-0", "outline-2", "outline-4", "outline-8",
        "outline-(length:--my-width)", "outline-[2vw]",
        
        // Outline Color
        "outline-inherit", "outline-current", "outline-transparent", "outline-black", "outline-white",
        "outline-red-500", "outline-blue-600", "outline-green-700",
        "outline-blue-600/50", "outline-red-500/75",
        "outline-(--my-color)", "outline-[#243c5a]",
        
        // Outline Style
        "outline-solid", "outline-dashed", "outline-dotted", "outline-double", "outline-none", "outline-hidden",
        
        // Outline Offset
        "outline-offset-0", "outline-offset-2", "outline-offset-4", "outline-offset-8",
        "-outline-offset-2", "-outline-offset-4",
        "outline-offset-(--my-offset)", "outline-offset-[2vw]",
    ];
