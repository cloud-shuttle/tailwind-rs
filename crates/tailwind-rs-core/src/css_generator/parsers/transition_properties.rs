...
impl TransitionPropertiesParser {
    ...
    fn parse_transition_duration_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "duration-75" => Some(vec![CssProperty {
                name: "transition-duration".to_string(),
                value: "75ms".to_string(),
                important: false,
            }]),
            "duration-100" => Some(vec![CssProperty {
                name: "transition-duration".to_string(),
                value: "100ms".to_string(),
                important: false,
            }]),
            "duration-150" => Some(vec![CssProperty {
                name: "transition-duration".to_string(),
                value: "150ms".to_string(),
                important: false,
            }]),
            "duration-200" => Some(vec![CssProperty {
                name: "transition-duration".to_string(),
                value: "200ms".to_string(),
                important: false,
            }]),
            "duration-300" => Some(vec![CssProperty {
                name: "transition-duration".to_string(),
                value: "300ms".to_string(),
                important: false,
            }]),
            "duration-500" => Some(vec![CssProperty {
                name: "transition-duration".to_string(),
                value: "500ms".to_string(),
                important: false,
            }]),
            "duration-700" => Some(vec![CssProperty {
                name: "transition-duration".to_string(),
                value: "700ms".to_string(),
                important: false,
            }]),
            "duration-1000" => Some(vec![CssProperty {
                name: "transition-duration".to_string(),
                value: "1000ms".to_string(),
                important: false,
            }]),
            _ => None,
        }
    ...
    fn parse_transition_delay_class(&self, class: &str) -> Option<Vec<CssProperty>> {
        match class {
            "delay-75" => Some(vec![CssProperty {
                name: "transition-delay".to_string(),
                value: "75ms".to_string(),
                important: false,
            }]),
            "delay-100" => Some(vec![CssProperty {
                name: "transition-delay".to_string(),
                value: "100ms".to_string(),
                important: false,
            }]),
            "delay-150" => Some(vec![CssProperty {
                name: "transition-delay".to_string(),
                value: "150ms".to_string(),
                important: false,
            }]),
            "delay-200" => Some(vec![CssProperty {
                name: "transition-delay".to_string(),
                value: "200ms".to_string(),
                important: false,
            }]),
            "delay-300" => Some(vec![CssProperty {
                name: "transition-delay".to_string(),
                value: "300ms".to_string(),
                important: false,
            }]),
            "delay-500" => Some(vec![CssProperty {
                name: "transition-delay".to_string(),
                value: "500ms".to_string(),
                important: false,
            }]),
            "delay-700" => Some(vec![CssProperty {
                name: "transition-delay".to_string(),
                value: "700ms".to_string(),
                important: false,
            }]),
            "delay-1000" => Some(vec![CssProperty {
                name: "transition-delay".to_string(),
                value: "1000ms".to_string(),
                important: false,
            }]),
